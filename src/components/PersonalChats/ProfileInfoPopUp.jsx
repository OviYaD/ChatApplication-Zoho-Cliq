...
import { getProfileAndLastMessage } from '../../api/chats/chat';
import "./ProfileInfoPopUp.scss"
import moment from 'moment/moment';

export default function ProfileInfoPopUp({ chatInfo }) {
            ...
            <div className='sub-container'>
                ...
                <div className='profile-info'>
                    ...
                    <div className='lastChat'>
                        <div className=' flexC justifySB'>
                            <div className='flexC'>
                                ...
                                {/* <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" style={{ color: "rgb(98, 114, 130)" }} width="14" height="14" fill="currentColor" class="bi bi-chat-fill" viewBox="0 0 16 16">
                    ...
                    <div className="info-option flexC justifySB">
                        <span title='Send Direct Message'>
