...
export default function FilePreview({ chatInfo, shareFiles, setPreviewFile, fileData }) {
            ...
            <div id="participants" className="modalwindow  zcl-win-modal1 zcalgncntr zcbg_mask">
                <div>
                    <div className="mcontent zcrchmcnt" style={{ width: "750px", padding: "0px" }}>
                        ...
                        <div id="fileuploadwinbody" className="mcontent zfileupldcnt zppwd1">
                            <div id="filescontainer" className="zimgprvmn">
                                <div className="zcfuimgcnt" id="filespreviewlist">
                                    <div id="maincontainer" chid="1264013913143657497" className="zfleprv">
                                        <div type="file" fileindex="0" className="zcupldimgmn posl zfle" content="image/jpeg" fileextn=".jpg">
                                            <div className="zupldimg">
                                                ...
                                                <div id="filedetails" className="filedetails">
                                                    <div className="flexC w100">
                                                        <div className="flexG mR40 fname-con">
                                                            <div id="fname" className="flexC">

                                                                <span id="fnameholder" className="fname" purpose="editfname" type="fname" index="0" chid="1264013913143657497" fileextn=".jpg" data-val="20201126_113928">{fileData.name}</span>
                                                            </div>
                                                            <div id="fsize" className="mT2 pL5 font13">{fileSize}</div>
                                                        </div>
                                                        <div chid="1264013913143657497" purpose="annotateImg" className="zcl-icon zcl-icon--filled zcf-edit2 fshrink" title="Edit image">
                                            ...
                                            <div className="zcffcmtcnt mT20" fileindex="0">
                                                <div className="flex w100 dN p8 zcf-schedulemsgprompt posrel" data-view="schedulemsgprompt"></div>
                                                <div id="composer-component-2" composer-component="" className="zc-composer-wrap">
                                                    <div className="zc-composer-cont">
                                                        <div className="zc-composer-main" composer-main-container="">
                                                            <div attachment-feature-container=""></div>
                                                            <div
                                                                id="composer-component-2-editor"
                                                                className="zc-composer-input zcaudiorecord"
                                                    ...
                                                    <div className="zc-composer-emoji flexM"><em className="zcf-emoji cur" id="composer-component-2-smiley-icon" data-composer-id="composer-component-2" data-action="openSmileyContainer"></em></div>
                                                    <div id="composer-component-2-smiley-container" className="smileydivmn" ignore_sticker="true" ignore_giphy="true"></div>
                            ...
                            <div className="chatarea" style={{ bottom: "30px", marginLeft: "30px", width: "100%", background: "transparent" }}>
                    ...
                    <div className="fileshare-ftr flexC" style={{ marginTop: "-15px" }}>
                        ...
                        <div className="mLA fshrink" style={{ marginTop: "-25px" }} id="fileactionbtns">
                            <button purpose="cancel" style={{ color: "var(--color-lp1)", border: "1px solid var(--color-lp3)" }} className="zcl-btn zcl-btn--secondary" tabindex="1" onClick={() => setPreviewFile(false)}>Cancel</button>
                            <button purpose="upload" className="zcl-btn zcl-btn--primary mL20 zcl-split-btn" tabindex="0" clearcomposer="true" onClick={() => { shareFiles(message); setPreviewFile(false) }}>
                                <span>Share</span><span id="scheduleasoption" className="split-icon flexM zcf-schedule" purpose="showDropDownOptions" style={{ marginLeft: "10px" }}>
