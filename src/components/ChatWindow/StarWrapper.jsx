...
export default function StarWrapper({ setStarId, msgId, setMessages }) {
    ...
    return <>
        <OutsideClickHandler onOutsideClick={() => setStarId("")}>
            <div class="staroptnsbox chtwndw" style={{ zIndex: "10000", marginLeft: "1.5rem" }}>
                <span purpose="star" type="1" class="msi-starsel type1" onClick={() => handleStar(msgId, "IMPORTANT")}>
                    <span>
                ...
                <span purpose="star" type="2" class="msi-starsel type2" onClick={() => handleStar(msgId, "TODO")}>
                ...
                <span purpose="star" type="3" class="msi-starsel type3" onClick={() => handleStar(msgId, "NOTE")}>
                    <span>
                ...
                <span purpose="star" type="4" class="msi-starsel type4" onClick={() => handleStar(msgId, "MANAGER")}>
                    <span>
                ...
                <span purpose="star" type="5" class="msi-starsel type5" onClick={() => handleStar(msgId, "FLLOWUP")}>
                    <span>
