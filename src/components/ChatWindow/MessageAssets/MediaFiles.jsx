        ...
        <div className="media-files">
            ...
            <div className='media-info flexC justifySB'>
                ...
                <div className="media-search flexC justifyE mL20">
                    <div id="ml_search" className="zcl-search ml-search">
                        <div id="ml_search_icon" className="zcl-seach-icon zcf-search2 zcl-icon--default" data-action="showSearchInput">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
                            </svg>
                        </div>
                        <div className="zcl-search-input flexC"><input id="ml_search_input" type="text" placeholder="Search by file name" /><span data-action="clearSearch" className="zcl-search-clear">Clear</span></div>
                        <div data-action="hideSearch" className="zcl-seach-close zcf-close clr-icon font10 zcl-dropdown-divider">
                    ...
                    <div id="sharedByDrpdwn" data-action="show_drpdwn_options" className=" drpdwn-input fshrink drpdwn-wrp mLR20 mlsharedby flexC posrel ">
                        <div className="flexC">
                            <div id="ml_sharedby_txt" className="clr-lp1 font13 clr6">Shared By:</div>
                            <div className="mL8 flexC">
                                <div id="filter_txt" className="selectedusers clr-H font13">All</div>
                                <em className="mL8 clr-icon zcf-downArrow font10"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-down" viewBox="0 0 16 16">
                                    <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                </svg></em>
                                <div id="sharedByOptns" className="zcl-menu-wrap posa no-pointer " >
                                    <div className="zcl-menu-item justifySB" data-chid="CT_1280427390976451600_60016673028" data-uid="{{uid}}" data-action="removeUserFilter">All <em id="allsel" className="clrG msi-tick p5"></em></div>
                                    <div className="zcl-menu-item justifySB" data-chid="CT_1280427390976451600_60016673028" data-uid="60016689094" data-action="filterMediaByUserId">You <em id="byCurrUsersel" className="clrG msi-tick dN p5"></em></div>
                                    <div id="channelFilter" className="zcl-menu-item jsutifySB" data-chid="CT_1280427390976451600_60016673028" data-action="channelUserIdFilter">
                                        Specific User <em className="zcf-rightArrow mL20"></em>
                                        <div id="addparticipants" className="ml-filter"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="drpdwn-wrp zcl-icon zcl-icon--default posrel ml-date" style={{ marginRight: "20px", marginLeft: "0px" }}>
                        <em className="zcf-calendar p10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" className="bi bi-calendar" viewBox="0 0 16 16">
            ...
            <div id="ml-data-container" zc_sticky_title_list="" data-uid="CT_1280427390976451600_60016673028" className="flexW ovrflwA ml-data-container">
                <div className="fshrink medialisting-sticky-title"><div id="date_seperater_1674791112627" zc_running_title="2" className="mT20 fontB w100 ml-datesep line24 vsbH" style={{ display: "none" }}>January, 2023</div></div>
                <div id="grid_layout1" className="gridlay">
                    <div id="grid_item_60016688891_1674791112627" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
...
Happy birthday!!!🎂🎂🥳🥳🥳"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1674791112655%202022683459917" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016688891_1674791112627" data-chid="CT_1280427390976451600_60016673028" title="Karthikeyan Velumani" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016688891" nname="Karthikeyan Velumani" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016688891" src="https://contacts.zoho.in/file?ID=60016688891&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016688891" className="zctxtseln cur">Karthikeyan Velumani</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1674791112655%202022683459917" uid="60016688891_1674791112627" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        ...
                                        className="zcimg-actn-btn p5 mL8 curP"
                                    >
                                        <em className="zcf-download"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-download" viewBox="0 0 16 16">
                                    ...
                                    <div
                                        ...
                                        data-chid="CT_1280427390976451600_60016673028"
                                        data-uid="60016688891_1674791112627"
                                        className="zcimg-actn-btn p5 mL8 curP textC ml-drpdwm_menu"
                                        title="More"
                                    >
                                        <em className="zcf-more"></em>
                                    </div>
                                </div>
                            </div>
                            <div data-name="forward_selection" data-uid="60016688891_1674791112627" msguid="1674791112655%202022683459917" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016688891_1674791112627" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016688891_1674791112627" data-name="frwrd_input" type="checkbox" data-uid="60016688891_1674791112627" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                                    ...
                                    rel="preload"
                                    className="ml-image-item"
                                    style={{ animation: "1s ease 0s 1 normal none running fadein" }}
                                />
                            </div>
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">png</span></span>
                            <div id="details_footer_60016688891_1674791112627" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Copy_of_Well_Done-__6_.png</div>
                                </div>
                                <div className="font12 ml-filesize">476 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016800367_1674189961835" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1674189961862%201992017539178" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016800367_1674189961835" data-chid="CT_1280427390976451600_60016673028" title="Sofia D Shyam" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016800367" nname="undefined" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016800367" src="https://contacts.zoho.in/file?ID=60016800367&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016800367" className="zctxtseln cur">undefined</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1674189961862%201992017539178" uid="60016800367_1674189961835" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016800367_1674189961835" msguid="1674189961862%201992017539178" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016800367_1674189961835" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016800367_1674189961835" data-name="frwrd_input" type="checkbox" data-uid="60016800367_1674189961835" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">jpg</span></span>
                            <div id="details_footer_60016800367_1674189961835" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Yellow_Happy_Party_Birthday_Poster__2_.jpg</div>
                                </div>
                                <div className="font12 ml-filesize">298 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016800367_1673932856466" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1673932856506%201987465465818" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016800367_1673932856466" data-chid="CT_1280427390976451600_60016673028" data-action="user_details" className="ml-list-img flexM" title="Sofia D Shyam">
                                    <div msguid="undefined" purpose="sender" sender="60016800367" nname="undefined" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016800367" src="https://contacts.zoho.in/file?ID=60016800367&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016800367" className="zctxtseln cur">undefined</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1673932856506%201987465465818" uid="60016800367_1673932856466" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016800367_1673932856466" msguid="1673932856506%201987465465818" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016800367_1673932856466" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016800367_1673932856466" data-name="frwrd_input" type="checkbox" data-uid="60016800367_1673932856466" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">jpg</span></span>
                            <div id="details_footer_60016800367_1673932856466" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Yellow_Happy_Party_Birthday_Poster__1_.jpg</div>
                                </div>
                                <div className="font12 ml-filesize">250 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016681512_1673756219551" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1673756219577%201974403926545" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016681512_1673756219551" data-chid="CT_1280427390976451600_60016673028" title="Mahalakshmi C" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016681512" nname="Mahalakshmi C" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016681512" src="https://contacts.zoho.in/file?ID=60016681512&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016681512" className="zctxtseln cur">Mahalakshmi C</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1673756219577%201974403926545" uid="60016681512_1673756219551" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016681512_1673756219551" msguid="1673756219577%201974403926545" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016681512_1673756219551" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016681512_1673756219551" data-name="frwrd_input" type="checkbox" data-uid="60016681512_1673756219551" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">PNG</span></span>
                            <div id="details_footer_60016681512_1673756219551" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">image15-01-2023_09_46_55_78.PNG</div>
                                </div>
                                <div className="font12 ml-filesize">322 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016688891_1673753808432" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1673753808450%201970106549371" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016688891_1673753808432" data-chid="CT_1280427390976451600_60016673028" title="Karthikeyan Velumani" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016688891" nname="Karthikeyan Velumani" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016688891" src="https://contacts.zoho.in/file?ID=60016688891&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016688891" className="zctxtseln cur">Karthikeyan Velumani</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1673753808450%201970106549371" uid="60016688891_1673753808432" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016688891_1673753808432" msguid="1673753808450%201970106549371" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016688891_1673753808432" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016688891_1673753808432" data-name="frwrd_input" type="checkbox" data-uid="60016688891_1673753808432" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">png</span></span>
                            <div id="details_footer_60016688891_1673753808432" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Copy_of_Well_Done-__5_.png</div>
                                </div>
                                <div className="font12 ml-filesize">801 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016681512_1673266833710" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1673266833741%201939554801244" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016681512_1673266833710" data-chid="CT_1280427390976451600_60016673028" title="Mahalakshmi C" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016681512" nname="Mahalakshmi C" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016681512" src="https://contacts.zoho.in/file?ID=60016681512&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016681512" className="zctxtseln cur">Mahalakshmi C</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1673266833741%201939554801244" uid="60016681512_1673266833710" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016681512_1673266833710" msguid="1673266833741%201939554801244" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016681512_1673266833710" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016681512_1673266833710" data-name="frwrd_input" type="checkbox" data-uid="60016681512_1673266833710" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">png</span></span>
                            <div id="details_footer_60016681512_1673266833710" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">image.png</div>
                                </div>
                                <div className="font12 ml-filesize">343 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016800367_1672983083697" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1672983083722%201926386151781" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016800367_1672983083697" data-chid="CT_1280427390976451600_60016673028" title="Sofia D Shyam" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016800367" nname="undefined" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016800367" src="https://contacts.zoho.in/file?ID=60016800367&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016800367" className="zctxtseln cur">undefined</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1672983083722%201926386151781" uid="60016800367_1672983083697" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016800367_1672983083697" msguid="1672983083722%201926386151781" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016800367_1672983083697" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016800367_1672983083697" data-name="frwrd_input" type="checkbox" data-uid="60016800367_1672983083697" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">jpg</span></span>
                            <div id="details_footer_60016800367_1672983083697" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Yellow_Happy_Party_Birthday_Poster.jpg</div>
                                </div>
                                <div className="font12 ml-filesize">330 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016681512_1672905855064" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1672905855124%201922013954508" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016681512_1672905855064" data-chid="CT_1280427390976451600_60016673028" title="Mahalakshmi C" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016681512" nname="Mahalakshmi C" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016681512" src="https://contacts.zoho.in/file?ID=60016681512&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016681512" className="zctxtseln cur">Mahalakshmi C</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1672905855124%201922013954508" uid="60016681512_1672905855064" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016681512_1672905855064" msguid="1672905855124%201922013954508" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016681512_1672905855064" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016681512_1672905855064" data-name="frwrd_input" type="checkbox" data-uid="60016681512_1672905855064" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">jpg</span></span>
                            <div id="details_footer_60016681512_1672905855064" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">Saravana_Kumar_V.jpg</div>
                                </div>
                                <div className="font12 ml-filesize">91 KB</div>
                            </div>
                        </div>
                    </div>
                    <div id="grid_item_60016681512_1672541350500" data-action="open_attachment" className="ml-grid-item curP posrel">
                        <div
                            data-name="item_cont"
                            className="h100 w100 posrel zhshare-src"
                        ...
                        >
                            <div id="grid_options" data-name="grid_options" msguid="1672541350526%201904469581701" className="grid_options posabs h100 flex dN flexS justifySB p10">
                                <div id="user_image" data-uid="60016681512_1672541350500" data-chid="CT_1280427390976451600_60016673028" title="Mahalakshmi C" data-action="user_details" className="ml-list-img flexM">
                                    <div msguid="undefined" purpose="sender" sender="60016681512" nname="Mahalakshmi C" className="sender ellips floatl">
                                        <div className="chtimg floatl posrel"><img elemtype="user" hover="true" uid="60016681512" src="https://contacts.zoho.in/file?ID=60016681512&amp;exp=6000&amp;t=user&amp;fs=thumb" className="cur" /></div>
                                        <span elemtype="user" hover="true" uid="60016681512" className="zctxtseln cur">Mahalakshmi C</span>
                                    </div>
                                </div>
                                <div id="att_actions" className="flexC ml-icon_dom" msguid="1672541350526%201904469581701" uid="60016681512_1672541350500" data-chid="CT_1280427390976451600_60016673028">
                                    <div
                                        id="download_icon"
                                        documentclick="attdownload"
                                        data-action="download_attachment"
                            ...
                            <div data-name="forward_selection" data-uid="60016681512_1672541350500" msguid="1672541350526%201904469581701" className="dN posa h100 w100 mT5" data-action="selFrwdItem">
                                <label id="selItem" uid="60016681512_1672541350500" className="w100 flexIC curP">
                                    <div className="zcl-checkbox w100"><input id="frwdmsginfo_60016681512_1672541350500" data-name="frwrd_input" type="checkbox" data-uid="60016681512_1672541350500" /><span className="zcf-tick flexM"></span></div>
                                </label>
                            </div>
                            <div id="img_dom">
                                <img
                            ...
                            <span id="empty_thumb" data-name="empty_dom" className="dN ml-emptygrid-item flexM p12"><span className="dN ml-file-default ellips">PNG</span></span>
                            <div id="details_footer_60016681512_1672541350500" className="fshrink pT12 pB10 pR12 pL12 curP dN">
                                <div className="flexC mB5 font14">
                                    <em className="zcf-default-img ml-filename mR8 font13"></em>
                                    <div className="ellips">image01-01-2023_08_19_07_68.PNG</div>
                                </div>
                                <div className="font12 ml-filesize">244 KB</div>
                            </div>
                        </div>
                    </div>
                </div>
