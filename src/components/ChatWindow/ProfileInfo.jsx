...
import Profile from '../Organization/MemberList/Profile';
import CommonChats from '../Organization/MemberList/CommonChats';
    ...
    return <>
        <div id="myModal" className="modal">
            ...
            <div className="modal-content">
                <span id="winclose" className="zchat-close cclose" title="Close [Esc]" >
                ...
                <div id="peopleUserPreviewCnt" className="people-user-preview-cnt userdetail fdirC" style={{ marginLeft: "-35px", marginTop: "-60px" }}>
