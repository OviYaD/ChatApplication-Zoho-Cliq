...
export default function CreateChannelModal({ setStatus }) {
    ...
    const addParticipants = (data) => {
        const part = participants + data.email + ",";
    ...
    const handleCreateChannel = async () => {
        let partList = participants.split(",").map((part) => part.trim());
        partList = partList.filter((part, index) => {
            return partList.indexOf(part) === index && part.length > 0;
        })

        console.log(partList);
        await createChannel({ name: channelName, description: chnDes, visibility: true, type: "PUBLIC", participantsList: partList })
        setStatus(false);
    }
                ...
                <div className="channelcreation-modal-content">
                    ...
                    <div className='collectDetails'>
                        <div className="chnLevel">
                            <div className='flexC' style={{ marginTop: "30px", marginLeft: "9rem" }}>
                                ...
                                <button className='org-btn'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-incognito" style={{ marginRight: "5px" }} viewBox="0 0 16 16">
                        ...
                        <div className="chnfields">
                            <div className="zcl-row mT25 mTB10 pR36 flexC">
                                ...
                                {showList && <ContactListPopup addParticipants={addParticipants} setShowListStatus={setShowListStatus} participants={participants}></ContactListPopup>}
                            </div>
