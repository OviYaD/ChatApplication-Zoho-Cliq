...
export default function CreateChannelModal({ setStatus }) {
    ...
    const addParticipants = (data) => {
        ...
        console.log(memList)
        setMemList((memList) => [...memList, data.id]);
    }
                        ...
                        <div className='collectDetails'>
                            <div className="chnLevel">
                                <div className='flexC' style={{ marginTop: "30px", marginLeft: "9rem" }}>
                                    <button className={`org-btn ${chnType === "organization" && "btn-active"}`} onClick={() => { setChnType("organization"); setError(false) }}>
                                    ...
                                    <button className={`org-btn ${chnType === "personal" && "btn-active"}`} onClick={() => { setChnType("personal"); setError(false) }}>
