                            ...
                            <div className='opt-dropdown '>
                                <div>
                                    <FormControl sx={{ m: 1, minWidth: 200, fontFamily: "zoho-puvi-regular", fontSize: 1, color: "red" }} size="small">
                                        ...
                                        >
                                            <MenuItem value="">
                                                <em><span className="menu-text" style={{ fontFamily: "zoho-puvi-regular" }} >Normal Reply</span></em>
                                            </MenuItem>
                                            <MenuItem value={20}><span className="menu-text" >Twenty</span></MenuItem>
                                            <MenuItem value={30}><span className="menu-text" >Thirty</span></MenuItem>
                                        </Select>
                                    </FormControl>
                                </div>
                            </div>
