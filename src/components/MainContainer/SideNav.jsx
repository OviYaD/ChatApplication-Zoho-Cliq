...
export default function SideNav({ setActiveMenu, activeMenu }) {
    return <>
            ...
            <div id="lhs_module_nav" className="flex fdirC justifySB h100 lhs-module-navigator">
                <div className="overflow-controls">
                    <div id="lhs_module_items" className="flexG mB20 posrel ps-container ps-theme-default ps-active-y" data-ps-id="2467d49f-d46e-6e6d-32d8-d32c3528c4e1">
                        <div id="lhs_chats" className={`lhs-nav-item ${activeMenu === "chats" && "active"}`} onClick={() => setActiveMenu("chats")} purpose="showConvosTab">
                        ...
                        <div id="lhs_people" className={`lhs-nav-item ${activeMenu === "Org" && "active"}`} onClick={() => setActiveMenu("Org")} purpose="showMyOrgTab">
