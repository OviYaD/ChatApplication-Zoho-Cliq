...
export default function ShowInfo({ setStatus, userEmail }) {
    ...
    useEffect(() => {
        const getUserDetails = async () => {
            const profile = await getMemberDetails({ email: userEmail });
            console.log(profile)
            setDetails(profile);
        }
        getUserDetails();
        ...
        return <>
            <div id="peopleUserPreviewCnt" className="people-user-preview-cnt userdetail fdirC">
                <div id="peoplePreviewHdr" className="people-user-preview-hdr posrel flexC">
                    <div id="peoplePreviewSubHdr" className="winheader zcl-hdrline"><span id="hdr60016689751" data-key="60016689751" elemtype="contact" purpose="search" style={{ textTransform: "capitalize" }}>{userDetails.first_name}</span>
                    ...
                    <div id="60016689751" className="hvprofileinfo" data-component="profileview">
                        <div className="zcbsprfl">
                            ...
                            <div className="usrinfo ellips">
                                <span id="contactdname60016689751" className="flexC"><span className="ellips font18 bold" style={{ textTransform: "capitalize" }}>{userDetails.first_name}</span><span id="checkin_status" uid="60016689751" className="font14 checkin_status zcpredot"></span></span>
                                <div id="contactmailid60016689751" className="mT8 ellips">
                                    <div className="deptinfo lineN">
                                        <div id="deprt60016689751" className="posl ellips">{userDetails.email}</div>
